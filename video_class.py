...
class Video:
    def __init__(self, master, path) -> None:
        ...
        self.play_pause_btn = Button(master, text="توقف", bg="light blue", font=("Vazirmatn Medium"), command=self.play_pause)
        self.play_pause_btn.pack()

        self.progress_slider = Scale(master, from_=0, to=self.vid_player.duration(), orient="horizontal", command=self.seek, bg="light blue", font=("Vazirmatn Medium"))
