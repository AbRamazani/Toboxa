...
def open_rotate_v_page(pre_page):
    ...
    Label(rotate_v, text="چرخاندن ویدئو", bg="light blue", justify="center", font=("Vazirmatn bold", 35)).place(x=325, y=0)
    ...
    def open_vid_page(path):
        ...
        Label(vid_p, text="توجه : تصویر زیر تنها برای نمایش خروجی است و خروجی با کیفیت اصلی ذخیره می شود", bg="light blue", font=("Vazirmatn bold", 10), fg="red").pack()
        ...
        Label(vid_p, text="میزان چرخش(پادساعتگرد)", bg="light blue", font=("Vazirmatn bold", 14)).pack()

        rotate_val = IntVar(value=360)
        rotate_s = Spinbox(vid_p, font=("Vazirmatn bold", 15), textvariable=rotate_val, from_=1, to=360, wrap=True, command=rotate_show)
        rotate_s.pack()
        ...
        render = Button(vid_p, text="انجام", bg="light blue", font=("Vazirmatn bold", 15), command=rotate).pack()
