...
def open_area_page(pre_page):
    ...
    Button(hamburgar_menu, text="تبدیل تاریخ", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=date).place(x=0, y=80, width=150, height=35)
    ...
    def rectangle_page():
        ...
        # sides:
        Label(rectangle, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(rectangle, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(rectangle, text=":b ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(rectangle, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        ...
        Button(rectangle, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(rectangle, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def square_page():
        ...
        # sides:
        Label(square, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(square, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        ...
        Button(square, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(square, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def parallelogram_page():
        ...
        # sides:
        Label(parallelogram, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(parallelogram, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(parallelogram, text=":h ارتفاع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(parallelogram, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        ...
        Button(parallelogram, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(parallelogram, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def rhombus_page():
        ...
        # sides:
        Label(rhombus, text=":k1 قطر", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(rhombus, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(rhombus, text=":k2 قطر", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(rhombus, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        ...
        Button(rhombus, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(rhombus, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def triangle_page():
        ...
        # sides:
        Label(triangle, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(triangle, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(triangle, text=":h ارتفاع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(triangle, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        ...
        Button(triangle, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(triangle, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def trapezoid_page():
        ...
        # sides:
        Label(trapezoid, text=":c ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(trapezoid, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(trapezoid, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(trapezoid, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        Label(trapezoid, text=":h ارتفاع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_h = Entry(trapezoid, font=("Vazirmatn Medium", 10, "bold"))
        side_h.pack()
        ...
        Button(trapezoid, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(trapezoid, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def pentagon_page():
        ...
        # sides:
        Label(pentagon, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(pentagon, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        ...
        Button(pentagon, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(pentagon, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def hexagon_page():
        ...
        # sides:
        Label(hexagon, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(hexagon, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        ...
        Button(hexagon, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(hexagon, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def octagon_page():
        ...
        # sides:
        Label(octagon, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(octagon, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        ...
        Button(octagon, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(octagon, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def circle_page():
        ...
        # sides:
        Label(circle, text=":a شعاع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(circle, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        ...
        Button(circle, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(circle, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
    ...
    def ellipse_page():
        ...
        # sides:
        Label(ellipse, text=":a ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_a = Entry(ellipse, font=("Vazirmatn Medium", 10, "bold"))
        side_a.pack()
        Label(ellipse, text=":b ضلع", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
        side_b = Entry(ellipse, font=("Vazirmatn Medium", 10, "bold"))
        side_b.pack()
        ...
        Button(ellipse, text="محاسبه کن", bg="light blue", font=("Vazirmatn Medium", 15, "bold"), command=comp).pack(pady=20)

        finall_show = Label(ellipse, bg="light blue", font=("Vazirmatn Medium", 15, "bold"))
        finall_show.pack()
