...
def open_area_page(pre_page):
    ...
    Button(hamburgar_menu, text="تبدیل تاریخ", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn", 16), command=date).place(x=0, y=80, width=150, height=35)
    ...
    Button(hamburgar_menu, text="خروج", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn", 17), command=area.destroy).place(x=0, y=550, width=150, height=50)
