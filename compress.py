...
def open_compress_page(pre_page):
    ...
    Button(hamburgar_menu, text="ویرایشگر متن", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=text_editor).place(x=0, y=100)
    Button(hamburgar_menu, text="خروج", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=compress.destroy).place(x=0, y=550)

    # title and img
    Label(compress, image=img, bg="light blue").place(x=150, y=0)
    Label(compress, text="فشره‌سازی‌فایل‌های‌وب", bg="light blue", justify="center", font=("Vazirmatn Medium", 27, "bold")).place(x=300, y=25)
    ...
    Button(cadr, text="بازکردن یک فایل", font=("Vazirmatn Medium", 13, "bold"), bg="light blue", command=open_file).place(x=35, y=0)

    input_text = Text(cadr, font=("Vazirmatn Medium", 10), width=28, height=18, undo=True, wrap=WORD)
    ...
    html = Button(cadr, text="فشرده\nسازی\nHTML", font=("Vazirmatn Medium", 10, "bold"), bg="light blue", command=compress_html)
    html.place(x=218, y=100)
    css = Button(cadr, text="فشرده\nسازی\nCSS", font=("Vazirmatn Medium", 10, "bold"), bg="light blue", command=compress_css)
    css.place(x=218, y=200)
    js = Button(cadr, text="فشرده\nسازی\nJS", font=("Vazirmatn Medium", 10, "bold"), bg="light blue", command=compress_js)
    js.place(x=218, y=300)
    reset = Button(cadr, text="بازنشانی", font=("Vazirmatn Medium", 8, "bold"), bg="light blue", command=reset_data)
    
    Button(cadr, text="ذخیره کردن خروجی", font=("Vazirmatn Medium", 13, "bold"), bg="light blue", command=save_text).place(x=300, y=0)

    output_text = Text(cadr, font=("Vazirmatn Medium", 10), width=28, height=18, undo=True, wrap=WORD)
    ...
    copy_b = Button(cadr, text="کپی کردن خروجی", font=("Vazirmatn Medium", 9, "bold"), bg="light blue", command=copy_text)
