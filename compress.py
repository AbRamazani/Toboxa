...
def open_compress_page(pre_page):
    ...
    Button(hamburgar_menu, text="ویرایشگر متن", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=text_editor).place(x=0, y=100)
    Button(hamburgar_menu, text="خروج", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=compress.destroy).place(x=0, y=550)

    # title and img
    Label(compress, image=img, bg="light blue").place(x=150, y=0)
    Label(compress, text="فشره‌سازی‌فایل‌های‌وب", bg="light blue", justify="center", font=("vazir bold", 27)).place(x=300, y=25)
    ...
    Button(cadr, text="بازکردن یک فایل", font=("vazir bold", 13), bg="light blue", command=open_file).place(x=35, y=0)

    input_text = Text(cadr, font=("vazir", 10), width=28, height=18, undo=True, wrap=WORD)
    ...
    html = Button(cadr, text="فشرده\nسازی\nHTML", font=("vazir bold", 10), bg="light blue", command=compress_html)
    html.place(x=218, y=100)
    css = Button(cadr, text="فشرده\nسازی\nCSS", font=("vazir bold", 10), bg="light blue", command=compress_css)
    css.place(x=218, y=200)
    js = Button(cadr, text="فشرده\nسازی\nJS", font=("vazir bold", 10), bg="light blue", command=compress_js)
    js.place(x=218, y=300)
    reset = Button(cadr, text="بازنشانی", font=("vazir bold", 8), bg="light blue", command=reset_data)
    
    Button(cadr, text="ذخیره کردن خروجی", font=("vazir bold", 13), bg="light blue", command=save_text).place(x=300, y=0)

    output_text = Text(cadr, font=("vazir", 10), width=28, height=18, undo=True, wrap=WORD)
    ...
    copy_b = Button(cadr, text="کپی کردن خروجی", font=("vazir bold", 9), bg="light blue", command=copy_text)
