...
def open_crop_i_page(pre_page):
    ...
    Button(hamburgar_menu, text="تغییر اندازه", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=resize_i).place(x=0, y=65)
    Button(hamburgar_menu, text="تغییر پسوند", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=format_i).place(x=0, y=100)
    Button(hamburgar_menu, text="چرخاندن تصویر", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=rotate_i).place(x=0, y=135)
    ...
    Button(hamburgar_menu, text="خروج", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=crop_i.destroy).place(x=0, y=550)

    # title and img
    Label(crop_i, image=img, bg="light blue").place(x=150, y=0)
    Label(crop_i, text="برش تصویر", bg="light blue", justify="center", font=("Vazirmatn Medium", 35, "bold")).place(x=350, y=0)
    ...
    def open_img_page(path):
        ...
        def help_page():
            ...
            Label(help_p, text="ویدئوی آموزش بُرش زدن تصویر", bg="light blue", font=("Vazirmatn Medium", 15, "bold")).pack()
            ...
            play_pause_btn = Button(help_p, text="توقف", bg="light blue", font=("Vazirmatn Medium"), command=play_pause)
            play_pause_btn.pack()

            skip_plus_5sec = Button(help_p, text="پنج ثانیه قبل", bg="light blue", font=("Vazirmatn Medium"), command=lambda: skip(-5))
            skip_plus_5sec.pack(side="left")

            start_time = Label(help_p, text=str(datetime.timedelta(seconds=0)), bg="light blue", font=("Vazirmatn Medium"))
            start_time.pack(side="left")

            progress_slider = Scale(help_p, from_=0, to=vid_player.duration(), orient="horizontal", command=seek, bg="light blue", font=("Vazirmatn Medium"))
            progress_slider.pack(side="left", fill="x", expand=True)
            
            end_time = Label(help_p, text=str(datetime.timedelta(seconds=vid_player.duration())).split(".")[0], bg="light blue", font=("Vazirmatn Medium"))
            ...
            skip_plus_5sec = Button(help_p, text="پنج ثانیه بعد", bg="light blue", font=("Vazirmatn Medium"), command=lambda: skip(5))
            skip_plus_5sec.pack(side="left")

            help_p.mainloop()

        c_b = Button(img_p, text="انجام", bg="light blue", font=("Vazirmatn Medium", 12, "bold"), command=crop)
        c_b.pack(pady=25)
        h_b = Button(img_p, text="راهنما", bg="light blue", font=("Vazirmatn Medium", 11, "bold"), command=help_page)
        h_b.pack()
        ...
        Button(img_p, bg="red", command=lambda: set_color("red"), text="بالا", font=("Vazirmatn Medium", 10, "bold")).place(x=w_bs*3, y=img_height+1.5, width=w_bs, height=20)
        Button(img_p, bg="blue", command=lambda: set_color("blue"), text="راست", font=("Vazirmatn Medium", 10, "bold")).place(x=w_bs*2, y=img_height+1.5, width=w_bs, height=20)
        Button(img_p, bg="green", command=lambda: set_color("green"), text="چپ", font=("Vazirmatn Medium", 10, "bold")).place(x=w_bs, y=img_height+1.5, width=w_bs, height=20)
        Button(img_p, bg="yellow", command=lambda: set_color("yellow"), text="پایین", font=("Vazirmatn Medium", 10, "bold")).place(x=2, y=img_height+1.5, width=w_bs, height=20)
