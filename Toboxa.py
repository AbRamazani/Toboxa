...
font.add_file("files/font/Vazirmatn-Medium.ttf")
...
def home():
    ...
    Button(hamburgar_menu, text="خانه", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_home).place(x=0, y=45, width=150, height=35)
    Button(hamburgar_menu, text="ریاضی", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_math).place(x=0, y=80, width=150, height=35)
    Button(hamburgar_menu, text="برنامه نویسی", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_programming).place(x=0, y=115, width=150, height=35)
    Button(hamburgar_menu, text="تصویر", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_image).place(x=0, y=150, width=150, height=35)
    Button(hamburgar_menu, text="ویدئو", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_video).place(x=0, y=185, width=150, height=35)
    Button(hamburgar_menu, text="سایر", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_other).place(x=0, y=220, width=150, height=35)
    Button(hamburgar_menu, text="درباره من", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 16), command=open_about).place(x=0, y=255, width=150, height=35)
    Button(hamburgar_menu, text="خروج", bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 17), command=root.destroy).place(x=0, y=550, width=150, height=50)

    # title and img
    Label(root, image=img, bg="light blue").place(x=150, y=0)
    Label(root, text="توبوکسا", bg="light blue", justify="center", font=("Vazirmatn Medium", 57, "bold")).place(x=375, y=0)
    Label(root, text="جعبه ابزاری برای رایانه شما", bg="light blue", fg="#404040", justify="center", font=("Vazirmatn Medium", 17, "bold")).place(x=365, y=110)
    ...
    categories_title = Label(cadr, text="دسته بندی ها", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=145, y=0)
    ...
    math_title = Button(cadr, text="ریاضی", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=open_math)
    ...
    programming_title = Button(cadr, text="برنامه نویسی", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=open_programming)
    ...
    image_title = Button(cadr, text="تصویر", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=open_image)
    ...
    video_title = Button(cadr, text="ویدئو", bg="light blue", bd=-2, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=open_video)
    ...
    other_title = Button(cadr, text="سایر", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=open_other)
    ...
    math_page_title = Label(math_page, text="ابزار های ریاضی", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=135, y=0)
    ...
    perimete_title = Button(math_page, text="محاسبه مساحت", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 17, "bold"), command=lambda: open_area_page(root))
    ...
    date_title = Button(math_page, text="تبدیل تاریخ", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_date_page(root))
    ...
    calculator_title = Button(math_page, text="ماشین حساب", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_calculator_page(root))
    ...
    unit_math_title = Button(math_page, text="مبدل واحد", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_unit_math_page(root))
    ...
    programming_page_title = Label(programming_page, text="ابزار های برنامه نویسی", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=85, y=0)
    ...
    lorem_title = Button(programming_page, text="لورم ساز", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_lorem_page(root))
    ...
    compress_title = Button(programming_page, text="فشرده‌سازی‌فایل‌‌وب", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 16, "bold"), command=lambda: open_compress_page(root))
    ...
    text_editor_title = Button(programming_page, text="ویرایشگر متن", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_texte_page(root))
    ...
    image_page_title = Label(image_page, text="ابزار های تصویر", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=130, y=0)
    ...
    crop_i_title = Button(image_page, text="برش", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_crop_i_page(root))
    ...
    resize_i_title = Button(image_page, text="تغییر اندازه", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_resize_i_page(root))
    ...
    foramt_i_title = Button(image_page, text="تغییر پسوند", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_format_i_page(root))
    ...
    rotate_i_title = Button(image_page, text="چرخاندن", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_rotate_i_page(root))
    ...
    filter_i_title = Button(image_page, text="قراردادن فیلتر", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_filter_i_page(root))
    ...
    video_page_title = Label(video_page, text="ابزار های ویدئو", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=150, y=0)
    ...
    crop_v_title = Button(video_page, text="برش", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_crop_v_page(root))
    ...
    foramt_v_title = Button(video_page, text="تغییر پسوند", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_format_v_page(root))
    ...
    rotate_v_title = Button(video_page, text="چرخاندن", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_rotate_v_page(root))
    ...
    paste_v_title = Button(video_page, text="ادغام ویدئوها", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_merge_v_page(root))
    ...
    other_page_title = Label(other_page, text="سایر ابزار ها", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=165, y=0)
    ...
    timer_title = Button(other_page, text="تایمر", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_timer_page(root))
    ...
    stopwatch_title = Button(other_page, text="کرنومتر", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_stopwatch_page(root))
    ...
    speed_title = Button(other_page, text="سرعت اینترنت", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_net_speed_page(root))
    ...
    password_title = Button(other_page, text="تولید کننده رمز", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_password_maker_page(root))
    ...
    qrcode_title = Button(other_page, text="QRcode تولید کننده", bg="light blue", bd=0, activebackground="light blue", font=("Vazirmatn Medium", 18, "bold"), command=lambda: open_qrcode_maker_page(root))
    ...
    about_page_title = Label(about_page, text="درباره من", bg="light blue", justify="center", font=("Vazirmatn Medium", 25, "bold")).place(x=175, y=0)
    Button(about_page, image=close_icon, bg="light blue", bd=0, activebackground="light blue", command=open_home).place(x=430, y=0)
    
    Label(about_page, text="ابوالفضل رمضانی متولد سال 1386 از قائن هستم", bg="light blue", justify="center", font=("Vazirmatn Medium", 15, "bold")).place(x=30, y=50)
    Label(about_page, text=": راه های تماس", bg="light blue", justify="center", font=("Vazirmatn Medium", 15, "bold")).place(x=160, y=80)
    ...
    Label(about_page, text=": راهنمای نرم افزار", bg="light blue", justify="center", font=("Vazirmatn Medium", 15, "bold")).place(x=150, y=180)
