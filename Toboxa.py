...
def home():
    ...
    Button(hamburgar_menu, text="خانه", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_home).place(x=0, y=30)
    Button(hamburgar_menu, text="ریاضی", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_math).place(x=0, y=65)
    Button(hamburgar_menu, text="برنامه نویسی", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_programming).place(x=0, y=100)
    Button(hamburgar_menu, text="تصویر", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_image).place(x=0, y=135)
    Button(hamburgar_menu, text="ویدئو", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_video).place(x=0, y=170)
    Button(hamburgar_menu, text="سایر", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_other).place(x=0, y=205)
    Button(hamburgar_menu, text="درباره من", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=open_about).place(x=0, y=240)
    Button(hamburgar_menu, text="خروج", width=13, bg="#01ab8c", fg="white", bd=0, font=("vazir", 15), command=root.destroy).place(x=0, y=550)

    # title and img
    Label(root, image=img, bg="light blue").place(x=150, y=0)
    Label(root, text="توبوکسا", bg="light blue", justify="center", font=("vazir bold", 50)).place(x=375, y=0)
    Label(root, text="جعبه ابزاری برای رایانه شما", bg="light blue", fg="#404040", justify="center", font=("vazir bold", 17)).place(x=360, y=100)
    ...
    categories_title = Label(cadr, text="دسته بندی ها", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=175, y=0)
    ...
    math_title = Button(cadr, text="ریاضی", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=open_math)
    ...
    programming_title = Button(cadr, text="برنامه نویسی", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=open_programming)
    ...
    image_title = Button(cadr, text="تصویر", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=open_image)
    ...
    video_title = Button(cadr, text="ویدئو", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=open_video)
    ...
    other_title = Button(cadr, text="سایر", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=open_other)
    ...
    math_page_title = Label(math_page, text="ابزار های ریاضی", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=165, y=0)
    ...
    perimete_title = Button(math_page, text="محاسبه مساحت", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_area_page(root))
    ...
    date_title = Button(math_page, text="تبدیل تاریخ", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_date_page(root))
    ...
    calculator_title = Button(math_page, text="ماشین حساب", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_calculator_page(root))
    ...
    unit_math_title = Button(math_page, text="مبدل واحد", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_unit_math_page(root))
    ...
    programming_page_title = Label(programming_page, text="ابزار های برنامه نویسی", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=127, y=0)
    ...
    lorem_title = Button(programming_page, text="لورم ساز", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_lorem_page(root))
    ...
    compress_title = Button(programming_page, text="فشرده‌سازی‌فایل‌‌وب", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_compress_page(root))
    ...
    text_editor_title = Button(programming_page, text="ویرایشگر متن", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_texte_page(root))
    ...
    image_page_title = Label(image_page, text="ابزار های تصویر", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=165, y=0)
    ...
    crop_i_title = Button(image_page, text="برش", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_crop_i_page(root))
    ...
    resize_i_title = Button(image_page, text="تغییر اندازه", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_resize_i_page(root))
    ...
    foramt_i_title = Button(image_page, text="تغییر پسوند", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_format_i_page(root))
    ...
    rotate_i_title = Button(image_page, text="چرخاندن", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_rotate_i_page(root))
    ...
    filter_i_title = Button(image_page, text="قراردادن فیلتر", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_filter_i_page(root))
    ...
    video_page_title = Label(video_page, text="ابزار های ویدئو", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=175, y=0)
    ...
    crop_v_title = Button(video_page, text="برش", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_crop_v_page(root))
    ...
    foramt_v_title = Button(video_page, text="تغییر پسوند", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_format_v_page(root))
    ...
    rotate_v_title = Button(video_page, text="چرخاندن", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_rotate_v_page(root))
    ...
    paste_v_title = Button(video_page, text="ادغام ویدئوها", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_merge_v_page(root))
    ...
    other_page_title = Label(other_page, text="سایر ابزار ها", bg="light blue", justify="center", font=("vazir bold", 20)).place(x=175, y=0)
    ...
    timer_title = Button(other_page, text="تایمر", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_timer_page(root))
    ...
    stopwatch_title = Button(other_page, text="کرنومتر", bg="light blue", bd=0, activebackground="light blue", font=("vazir bold", 15), command=lambda: open_stopwatch_page(root))
