...
def open_merge_v_page(pre_page):
    ...
    Button(hamburgar_menu, text="چرخاندن ویدئو", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=rotate_v).place(x=0, y=135)
    Button(hamburgar_menu, text="خروج", width=13, bg="#01ab8c", fg="white", bd=0, font=("Vazirmatn Medium", 15), command=merge_v.destroy).place(x=0, y=550)

    # title and img
    Label(merge_v, image=img, bg="light blue").place(x=150, y=0)
    Label(merge_v, text="ادغام ویدئوها", bg="light blue", justify="center", font=("Vazirmatn Medium", 35, "bold")).place(x=325, y=0)
    ...
    Label(cadr, text="توجه : ترتیب ادغام ویدئو ها بر اساس ترتیبی است که شما انتخاب می کنید", bg="light blue", font=("Vazirmatn Medium", 10, "bold"), fg="red").place(x=50, y=0)
    ...
    videos = Listbox(cadr, bg="light blue", fg="#01ab8c", font=("Vazirmatn Medium", 12))
    ...
    Button(cadr, text="ادغام ویدئو ها", bg="light blue", font=("Vazirmatn Medium", 17, "bold"), bd=0, activebackground="light blue", command=merge).place(x=180, y=356)
